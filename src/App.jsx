...
// import Calendarhd from './containers/Dashboard/Calendar/Calanderhd';
import Maincalendar from './containers/Dashboard/Calendar/Maincalendar';
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/calendar" element={<Maincalendar/>} />
          ...
          <Route path="/projectmanagement" element={<ProjectDashboard/>}/>       
        </Route>
      </Routes>
    </BrowserRouter>
  );
